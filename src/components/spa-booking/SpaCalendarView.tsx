...
import { format, addDays, startOfDay, endOfDay, isSameDay, parseISO, addMinutes, isBefore, isAfter, startOfWeek, endOfWeek } from 'date-fns';
          ...
          {Array.from({ length: 7 }).map((_, dayIndex) => {
            ...
            return (
              <div key={dayIndex} className="border rounded-md p-2">
                <div 
                  className={cn(
                    "text-center font-medium mb-1 p-1 rounded cursor-pointer",
